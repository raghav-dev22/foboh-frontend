...
function EditCustomerBtn({ selectedProductsLength, item}) {
    ...
    return (
        <>
         {selectedProductsLength === 1 &&
            ...
            onClick={() => navigate(`/dashboard/view-customer-details/`, { state : { data: item } })}
            >
                <div className="">
                ...
                <h6 className="text-darkGreen">Edit Customers</h6>
            </button>
        }
        </>
    )
