            ...
            <div className="px-12 pt-6">
                ...
                <div className="xl:w-full xl:mx-0  sm:block rounded-lg border border-darkGreen	">
                    ...
                    <div className="p-6">
                        ...
                        <div className={`${activeStatus == 2 ? "Active" : "hidden"}`}>
                            two
                        </div>
                        <div className={`${activeStatus == 3 ? "Active" : "hidden"}`}>
                            three
                        </div>

                        <div className={`${activeStatus == 4 ? "Active" : "hidden"}`}>
                            three
                        </div>
                    </div>
                </div>
