...
function Header() {
  ...
  return (
    <>
      <div className="header h-86 flex justify-between py-2 px-6 border-b border-inherit bg-white items-center	">
        <div className="">
        ...
        <div className=" flex gap-x-14 items-center	 ">
          <div className="flex gap-4 ">
            ...
            {/* {isOpen && (
                <ul
                  className="dropdown-content absolute bg-slate-100	p-2">
                  <li>
                    <a href="#">Option 1</a>
                  </li>
                  <li>
            ...
            <div className="dropdown">
              <div className="relative">
                <div
                  ...
                  className=" cursor-pointer absolute msg-no bg-custom-darkGreen rounded-full 	flex justify-center items-center"
                >
