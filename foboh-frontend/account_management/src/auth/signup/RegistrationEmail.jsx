      ...
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="w-full p-6 bg-white md:mt-0 sm:max-w-md  rounded-[22px] sm:p-8  shadow-xl">
          <div className="flex flex-col items-center scale-95">
            ...
            <p className="text-[#637381] text-[16px] font-inter leading-[20px]  my-4 flex-shrink-0 tracking-tight text-center">Almost there! An email containing your verification link<br />was sent to <span onClick={handleEmailLink} className='text-[#147D73] cursor-pointer underline'>{email}</span></p>
