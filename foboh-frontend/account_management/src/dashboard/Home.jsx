...
import SalesCard from "../widgets/cards/SalesCard";
import ActiveOrder from "../widgets/table/ActiveOrder";
import fobohLogo from "../../src/image/reset/fobohLogo.png";
                ...
                <div className="flex flex-no-wrap">
                    ...
                    <div className="absolute lg:relative w-72 h-  shadow bg-[#FFFFFF] shadow-[#0000001F] hidden lg:block">
                        ...
                        <ul aria-orientation="vertical" className=" py-6">
                            <li className="pl-6 cursor-pointer font-medium text-base leading-3 tracking-normal pb-4 pt-5 text-[#147D73] focus:text-[#147D73] focus:outline-none">
                                <div className="flex items-center">
                                    <div>
                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-home icon-tabler-grid" width={20} height={20} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <li className="pl-6 cursor-pointer text-[#637381] font-medium text-base leading-3 tracking-normal mt- mb-4 py-2 hover:text-[#147D73] focus:text-[#147D73] focus:outline-none">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2 text-base font-medium">Orders</span>
                                </div>
                            </li>
                            <li className="pl-6 cursor-pointer text-[#637381] font-medium text-base leading-3 tracking-normal  mb-4 py-2 hover:text-[#147D73] focus:text-[#147D73] focus:outline-none">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2 text-base font-medium">Customers</span>
                                </div>
                            </li>
                            ...
                            <li className="pl-6 cursor-pointer text-[#637381] font-medium text-base leading-3 tracking-normal  mb-4 py-2 hover:text-[#147D73] focus:text-[#147D73] focus:outline-none">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2 text-base font-medium">Products</span>
                                </div>
                            </li>
                            ...
                            <li className="pl-6 cursor-pointer text-[#637381] font-medium text-base leading-3 tracking-normal  mb-4 py-2 hover:text-[#147D73] focus:text-[#147D73] focus:outline-none">
                                <div className="flex items-center">
                                    ...
                                    <span className="ml-2 text-base font-medium">Pricing</span>
                                </div>
                            </li>
                        </ul>
                        ...
                        <div className="mt-16">
                            <div className="flex justify-center item-center">
                                <hr className="text-[#E7E7E7] w-[200px]" />
                            </div>
                            ...
                            <ul aria-orientation="vertical" className=" py-6">
                                <li className="pl-6 cursor-pointer font-medium text-base leading-3 tracking-normal pb-4 pt-5 text-[#147D73] focus:text-[#147D73] focus:outline-none">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-2 text-base font-medium">Chat</span>
                                    </div>
                                </li>
                                <li className="pl-6 cursor-pointer text-[#637381] font-medium text-base leading-3 tracking-normal mt- mb-4 py-2 hover:text-[#147D73] focus:text-[#147D73] focus:outline-none">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-2 text-base font-medium">Setting</span>
                                    </div>
                                </li>
                                ...
                                <li className="pl-6 cursor-pointer text-[#637381] font-medium text-base leading-3 tracking-normal  mb-4 py-2 hover:text-[#147D73] focus:text-[#147D73] focus:outline-none">
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-2 text-base font-medium">Help</span>
                                    </div>
                                </li>
                            </ul>
                                    ...
                                    <ul aria-orientation="vertical" className=" py-6">
                                        ...
                                        <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ml-2 xl:text-base md:text-2xl text-base">Customers</span>
                                            </div>
                                        </li>
                                        <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal mt-4 mb-4 py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                            <div className="flex items-center">
                                        ...
                                        <li className="pl-6 cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-2 hover:text-indigo-700 focus:text-indigo-700 focus:outline-none">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ml-2 xl:text-base md:text-2xl text-base">Pricing</span>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div className="w-full bg-white">
                        {/* Navigation starts */}
                        <nav className=" h-[86px] p-5 flex items-center lg:items-stretch justify-end lg:justify-between bg-white shadow relative z-10">
                            <div className="hidden lg:flex w-full pr-6">
                                <div className="w-1/2 h-full hidden  md:flex items-center pl-6 pr-24">
                                    <div className="flex flex-col">
                                        <p className="text-xl font-semibold text-[#212B36]">Hello [first name] 👋</p>
                                        <span className="text-sm font-normal text-[#637381]">Welcome back to FOBOH!</span>

                                    </div>
                                </div>
                                <div className="w-1/2 hidden lg:flex">
                                    <div className="w-full flex items-center pl-8 justify-end gap-5">
                                        <div className="h-full w-12 flex items-center justify-center border rounded-lg ">
                                        ...
                                        <div className="h-full w-12 flex items-center justify-center border rounded-lg mr-4 cursor-pointer text-gray-600">
                                        ...
                                        <div className="flex items-center relative cursor-pointer gap-2" onClick={() => setProfile(!profile)}>
                                            <div className="flex flex-col">
                                                <p className="text-[#212B36] text-sm font-medium ">Tom Sheer</p>
                                                <span className="text-xs ms-1 text-[#637381] font-normal">Lo-Fi Wines</span>
                                            </div>
                                                    ...
                                                    <ul className="p-2 w-full border-r bg-white absolute rounded left-0 shadow mt-12 sm:mt-16 ">
                                                        ...
                                                        <li className="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mt-2">
                                                            <div className="flex items-center">
                                                                ...
                                                                <span className="text-sm ml-2">Help</span>
                                                            </div>
                                                        </li>
                                                        <li className="flex w-full justify-between text-gray-600 hover:text-indigo-700 cursor-pointer items-center mt-2">
                                                            <div className="flex items-center">
