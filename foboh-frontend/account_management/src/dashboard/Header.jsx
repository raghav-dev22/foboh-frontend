      ...
      <div className="bg-custom-skyBlue shadow-lg py-3 px-7 	">
        <div className="hidden md:block">
          <nav className="flex justify-between  ">
            <div className="">
              ...
              <p className="text-sm font-normal text-lightGray text-start">
                Welcome back to FOBOH!
              </p>
            </div>
            <div className=" flex lg:gap-x-14 gap-x-6 items-center	 ">
              ...
              <div className="relative dropdown">
                ...
                {isOpen && (
                  <div className=" z-10	   w-60 absolute user-dropdown bg-white	shadow-md rounded-lg	h-44	">
                    <ul className="dropdown-content 	 ">
                      <Link to="/dashboard/your-profile">
                        ...
                        <li className="py-2.5	px-4 border-t border-inherit	cursor-pointer		">
                          <h6
        ...
        <div className="block md:hidden w-full ">
          <div
            ...
            className="cursor-pointer  text-white  rounded flex justify-end items-center w-full"
          >
            {/* 
