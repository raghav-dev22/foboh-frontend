...
function ImportModal({Show, Hide}) {
    // const click = () => {
...
//     }
    ...
    return (
        <>
            {(Show) ? (
                <>
                    <div className=" bg-custom-blur flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
