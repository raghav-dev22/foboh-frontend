...
function BulkEditErrorModal({ show, setShow, error, loader }) {
  const navigate = useNavigate();

  const remove = () => {
    if (error.filter((i) => i).length === 0) {
      setShow(false);
                      ...
                      <div className="mt-2">
                        ...
                        >
                          <p className="text-sm font-normal">
                            ...
                            may have same SKU code or title that need correction
                  ...
                  >
                    <div className="flex gap-3" style={{ marginTop: "1rem" }}>
                      <button
                        ...
                        onClick={() => remove()}
                      >
                        <h5 className="text-white md:font-semibold md:text-base  text-sm font-medium">
                          Close
                        </h5>
                      </button>
                    </div>
...
export default BulkEditErrorModal;
