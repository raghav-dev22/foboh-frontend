...
function Filter() {
    ...
    const {filterTextFirst, filterTextSecond, filterTextThird, filterTextForth} = check
                            ...
                            <ul className="dropdown-content 	 ">
                                <li className="py-2.5	px-4	">
                                    <div className="flex items-center">
                                        ...
                                        <input
                                            defaultChecked=""
                                            id="default-radio-1" type="radio" name="filterTextFirst"  checked={filterTextFirst} onChange={changeHandler} 
                                            defaultValue=""
                                ...
                                <li className="py-2.5	px-4	">
                                    ...
                                    <div className="flex items-center" >
                                        ...
                                        <input
                                            defaultChecked=""
                                            id="default-radio-2" type="radio" name="filterTextSecond" checked={filterTextSecond} onChange={changeHandler}
                                            defaultValue=""
                                ...
                                <li className="py-2.5	px-4 	">
                                    <div className="flex items-center" >
                                        ...
                                        <input
                                            defaultChecked=""
                                            id="default-radio-3" type="radio" name="filterTextThird" checked={filterTextThird} onChange={changeHandler}
                                            defaultValue=""
                                ...
                                <li className="py-2.5	px-4 	">
                                    <div className="flex items-center" >
                                        ...
                                        <input
                                            defaultChecked=""
                                            id="default-radio-4" type="radio" name="filterTextForth" checked={filterTextForth} onChange={changeHandler}
                                            defaultValue=""
