      ...
      handlePrint(orderId) {
        ...
        setTimeout(() => {
          ...
          var val = htmlToPdfmake(
            `<table>
            <tr>
            <td style="width:200px">Billed to</td>
            <td style="width:200px">Billed from</td>
            <td style="width:250px">Order number</td>
            
          </tr>
          <tr>
            <td style="width:200px">${invoiceData?.buyerBusinessName}</td>
            <td style="width:200px">${invoiceData?.businessName}</td>
            <td style="width:250px">${invoiceData?.orderId}</td>
