...
// import "./InvoiceExcludingWet.css";

function InvoiceExcludingWET() {
  return (
    <div className="bg-gray-400">
      <div className="box-border bg-white w-[595px] h-[770px] m-auto p-8 border">
...
export default InvoiceExcludingWET;
